...
const menus = [
    ...
    { name: 'MMPP Merma', path: '/mmp-merma', component: MMPPMerma },
    { name: 'Solicitud de Material', path: '/solicitud-material', component: SolicitudMaterial },
    { name: 'Ayuda Receta', path: '/ayuda-receta', component: AyudaReceta },
];
